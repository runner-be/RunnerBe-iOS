...
class EmailCertificationInitModalViewController: BaseViewController {
    ...
    init(viewModel: EmailCertificationInitModalViewModel) {
    ...
    private var viewModel: EmailCertificationInitModalViewModel
...
extension EmailCertificationInitModalViewController {
