...
class NickNameChangeModalViewController: BaseViewController {
    ...
    init(viewModel: NickNameChangeModalViewModel) {
    ...
    private var viewModel: NickNameChangeModalViewModel
    ...
    private var titleLabel = UILabel().then { label in
        ...
        label.text = L10n.MyPage.Settings.Modal.NickName.content
...
extension NickNameChangeModalViewController {
