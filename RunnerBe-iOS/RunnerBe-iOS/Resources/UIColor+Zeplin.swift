...
extension UIColor {
  @nonobjc class var darkG6: UIColor {
    return UIColor(red: 41.0 / 255.0, green: 38.0 / 255.0, blue: 32.0 / 255.0, alpha: 1.0)
  }
  ...
  @nonobjc class var primary: UIColor {
    return UIColor(red: 1.0, green: 224.0 / 255.0, blue: 130.0 / 255.0, alpha: 1.0)
  }
  ...
  @nonobjc class var primarydarker: UIColor {
    return UIColor(red: 89.0 / 255.0, green: 87.0 / 255.0, blue: 82.0 / 255.0, alpha: 1.0)
  }
  @nonobjc class var darkG5: UIColor {
    return UIColor(red: 65.0 / 255.0, green: 63.0 / 255.0, blue: 57.0 / 255.0, alpha: 1.0)
  }
  @nonobjc class var darkG55: UIColor {
    return UIColor(red: 54.0 / 255.0, green: 52.0 / 255.0, blue: 45.0 / 255.0, alpha: 1.0)
  }
  @nonobjc class var darkG4: UIColor {
    return UIColor(red: 111.0 / 255.0, green: 109.0 / 255.0, blue: 105.0 / 255.0, alpha: 1.0)
  }
  @nonobjc class var darkG25: UIColor {
    return UIColor(white: 189.0 / 255.0, alpha: 1.0)
  }
  @nonobjc class var darkG35: UIColor {
    return UIColor(red: 141.0 / 255.0, green: 140.0 / 255.0, blue: 137.0 / 255.0, alpha: 1.0)
  }
  @nonobjc class var darkG3: UIColor {
    return UIColor(red: 168.0 / 255.0, green: 168.0 / 255.0, blue: 165.0 / 255.0, alpha: 1.0)
  }
  @nonobjc class var darkG2: UIColor {
    return UIColor(red: 205.0 / 255.0, green: 205.0 / 255.0, blue: 201.0 / 255.0, alpha: 1.0)
  }
