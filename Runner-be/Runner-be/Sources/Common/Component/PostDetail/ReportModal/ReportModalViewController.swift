...
class ReportModalViewController: BaseViewController {
    ...
    private var viewModel: ReportModalViewModel
    ...
    private var titleLabel = UILabel().then { label in
        ...
        label.text = L10n.Home.PostDetail.Report.content
    ...
    private var buttonOk = UIButton().then { button in
        button.setTitle(L10n.Home.PostDetail.Report.Button.ok, for: .normal)
    ...
    private var buttonNo = UIButton().then { button in
        button.setTitle(L10n.Home.PostDetail.Report.Button.no, for: .normal)
        button.setTitleColor(.primary, for: .normal)
        button.setBackgroundColor(.clear, for: .normal)
