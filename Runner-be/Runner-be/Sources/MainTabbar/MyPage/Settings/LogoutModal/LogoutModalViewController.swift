...
class LogoutModalViewController: BaseViewController {
    ...
    init(viewModel: LogoutModalViewModel) {
    ...
    private var viewModel: LogoutModalViewModel
    ...
    private var titleLabel = UILabel().then { label in
        ...
        label.text = L10n.MyPage.Settings.Modal.Logout.content
    ...
    private var buttonOk = UIButton().then { button in
        button.setTitle(L10n.MyPage.Settings.Modal.Logout.Button.ok, for: .normal)
    ...
    private var buttonNo = UIButton().then { button in
        button.setTitle(L10n.MyPage.Settings.Modal.Logout.Button.cancel, for: .normal)
        button.setTitleColor(.primary, for: .normal)
        button.setBackgroundColor(.clear, for: .normal)
